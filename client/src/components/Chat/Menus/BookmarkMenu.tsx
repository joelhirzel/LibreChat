          ...
          <TooltipAnchor
            ...
            render={
              <Ariakit.MenuButton
                ...
                className={cn(
                  'mt-text-sm flex size-10 flex-shrink-0 items-center justify-center gap-2 rounded-xl border border-border-light text-sm transition-colors duration-200 bg-surface-secondary hover:bg-surface-hover',
